...
<p class="time-play"><?php echo esc_html( $item->video_duration ); ?></p>							<p class="playlist"><?php echo $item->video_title; ?></p>												
												<?php endif; ?>
				...
				<h1 style="color:#A6CE41;">Popular <span style="color:#00A0E3;">Videos</span></h1>	
